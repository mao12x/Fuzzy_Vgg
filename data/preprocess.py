...
def newU(U, ima, centro,m):
    ...
    for i in range(U.shape[0]):
        ...
        for n in range(U.shape[1]):
            ...
            Unew [i,n] = (r)**-1
    return Unew
#Data source paths that need to be processed by fuzzy
data_dir="/home/b226/yzm/fastai/ROAD/ROAD0/class0/"
nowdir="/home/b226/yzm/fastai/ROAD/ROAD0_fuzzy/class0"
s=data_dir + '/*.jpg'
coll = io.ImageCollection(s)
print(len(coll))
...
for index in range(len(coll)):
  ...
  #plt.show()
  io.imsave(nowdir+"class0"+str(index)+".jpg", cluster)
